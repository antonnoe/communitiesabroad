...
<div class="ca-av-toc">
  ...
  <ol>
    ...
    <li><a href="#av-netwerk-platforms">Het netwerk van platforms</a></li>
...
<p><strong>1.2 Netwerk van platforms:</strong> het geheel van onderling gekoppelde platforms, websites, applicaties en diensten die door Communities Abroad worden geëxploiteerd, zoals omschreven in artikel 3. In deze Voorwaarden afgekort tot "het Netwerk".</p>

<p><strong>1.3 Gebruiker:</strong> iedere natuurlijke persoon die gebruik maakt van één of meer onderdelen van het Netwerk, waaronder Forumgebruikers, Abonnees, Registranten en bezoekers.</p>
...
<p><strong>1.14 Content:</strong> alle informatie, teksten, berichten, afbeeldingen en overige materialen die door een Gebruiker worden geplaatst op of via het Netwerk.</p>
...
<p><strong>2.1</strong> Deze Voorwaarden zijn van toepassing op alle Overeenkomsten tussen Communities Abroad en een Gebruiker, Adverteerder of Registrant, alsmede op het gebruik van het Netwerk in het algemeen.</p>

<p><strong>2.2</strong> Door het aanmaken van een account, het afsluiten van een abonnement, het plaatsen van een Advertentie of Vermelding, of het anderszins gebruik maken van het Netwerk, erkent de Gebruiker van de inhoud van deze Voorwaarden op de hoogte te zijn en verklaart hij zich daarmee akkoord.</p>
...
<!-- ============================================================ -->
<h2 id="av-netwerk-platforms">Artikel 3. Het netwerk van platforms</h2>

<p><strong>3.1</strong> Communities Abroad exploiteert een samenhangend netwerk van platforms ten behoeve van Nederlandstalige personen die in Frankrijk wonen, werken of van plan zijn daarheen te verhuizen. Dit Netwerk bestaat uit de volgende onderdelen:</p>
...
<p><strong>3.2</strong> Op Infofrankrijk.com is een groeiend pakket van interactieve tools beschikbaar als geïntegreerde onderdelen van het Netwerk. Deze tools vallen in de volgende categorieën:</p>
...
<p>Het actuele en volledige overzicht van beschikbare tools is te vinden op de <a href="https://infofrankrijk.com/categorie/toolbox-infofrankrijk/">Toolbox-pagina van Infofrankrijk.com</a>. Communities Abroad kan te allen tijde tools toevoegen, wijzigen of verwijderen. De bepalingen in deze Voorwaarden — waaronder de disclaimers, aansprakelijkheidsbeperkingen en de freemium-structuur — zijn van toepassing op alle interactieve tools in het Netwerk, ongeacht of zij bij naam worden genoemd in deze Voorwaarden.</p>

<p><strong>3.3</strong> Deze Voorwaarden zijn van toepassing op alle onderdelen van het Netwerk. Voor specifieke onderdelen gelden aanvullende bepalingen zoals opgenomen in de artikelen 5 tot en met 13.</p>

<p><strong>3.4</strong> Communities Abroad behoudt zich het recht voor onderdelen van het Netwerk toe te voegen, te wijzigen of te beëindigen. Bij beëindiging van een onderdeel waarvan een Abonnee actief gebruik maakt, zal Communities Abroad de Abonnee hiervan ten minste 30 dagen vooraf in kennis stellen.</p>

<!-- ============================================================ -->
<h2 id="av-account">Artikel 4. Account en registratie</h2>

<p><strong>4.1</strong> Voor het gebruik van bepaalde onderdelen van het Netwerk is het aanmaken van een account vereist. De Gebruiker is verantwoordelijk voor het verstrekken van juiste en actuele gegevens bij registratie.</p>

<p><strong>4.2</strong> Het Netwerk kent gescheiden accountsystemen. Een account op Nederlanders.fr (forumaccount) staat los van een account op Infofrankrijk.com (portaalaccount). Het aanmaken van een forumaccount verleent geen toegang tot de betaalde diensten op Infofrankrijk.com en omgekeerd. De interactieve tools, Café Claude en DossierFrankrijk zijn gekoppeld aan het portaalaccount op Infofrankrijk.com via een eenmalige aanmelding (SSO).</p>
...
<p>Communities Abroad aanvaardt geen aansprakelijkheid voor schade die voortvloeit uit het gebruik van of het vertrouwen op door de interactieve tools berekende resultaten, gegenereerde analyses of weergegeven informatie. Dit geldt voor alle interactieve tools in het Netwerk, ongeacht of zij bij naam worden genoemd in deze Voorwaarden.</p>
...
<p>De Registrant garandeert dat met de plaatsing van de Vermelding geen inbreuk wordt gemaakt op rechten van derden. De Registrant verleent Communities Abroad een niet-exclusieve licentie voor het tonen en distribueren van de Vermelding binnen het Netwerk voor de duur van de Vermeldingsovereenkomst.</p>
...
<p><strong>14.1</strong> Alle intellectuele eigendomsrechten op het Netwerk en de daarin opgenomen content van Communities Abroad — waaronder teksten, artikelen, tools, software, ontwerpen en logo's — berusten bij Communities Abroad, tenzij uitdrukkelijk anders vermeld.</p>

<p><strong>14.2</strong> Het is de Gebruiker niet toegestaan om zonder voorafgaande schriftelijke toestemming van Communities Abroad content van het Netwerk te verveelvoudigen, openbaar te maken of anderszins te exploiteren.</p>
...
<p><strong>15.1</strong> Communities Abroad stelt het Netwerk met zorg samen en onderhoudt het naar beste vermogen, maar biedt alle diensten aan "as is" en garandeert niet dat het Netwerk ononderbroken, foutloos of volledig beschikbaar is.</p>
...
<p><strong>17.6</strong> Alle prijzen op het Netwerk zijn onder voorbehoud van typefouten. Voor de gevolgen van typefouten wordt geen aansprakelijkheid aanvaard.</p>
...
<p><strong>18.2</strong> De Privacyverklaring is beschikbaar op CommunitiesAbroad.com en Infofrankrijk.com en is van toepassing op alle onderdelen van het Netwerk. De Privacyverklaring vormt een integraal onderdeel van deze Voorwaarden.</p>

<p><strong>18.3</strong> Door gebruik te maken van het Netwerk erkent de Gebruiker kennis te hebben genomen van de Privacyverklaring.</p>
...
<p><strong>19.2</strong> Substantiële wijzigingen worden minimaal 30 dagen voor inwerkingtreding bekendgemaakt via het Netwerk en, indien van toepassing, per e-mail aan geregistreerde Gebruikers.</p>
...
<div class="ca-av-changelog">
  ...
  <ul>
    <li>Terminologische verduidelijking: de gedefinieerde term "Ecosysteem" (art. 1.2) is hernoemd tot "Netwerk van platforms", in deze Voorwaarden afgekort tot "het Netwerk". Alle vindplaatsen zijn consequent aangepast, inclusief de titel van artikel 3 en de daaraan gekoppelde anchor-id's. De strekking van de bepalingen blijft ongewijzigd.</li>
  </ul>
...
<div class="ca-av-footer">
  ...
  Deze Algemene Voorwaarden zijn van toepassing op het volledige Netwerk: Infofrankrijk.com, Nederlanders.fr, Nedergids.nl, DoctorsOnMaps.com, CaféClaude.fr, DossierFrankrijk.nl, Frankrijknieuws en CommunitiesAbroad.com.</p>
</div>
