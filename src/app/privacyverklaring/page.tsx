...
export const metadata: Metadata = {
  ...
  description:
    "Privacyverklaring van Communities Abroad — hoe wij uw persoonsgegevens verzamelen, gebruiken en beschermen.",
};
...
<div class="ca-privacy-toc">
  ...
  <ol>
    ...
    <li><a href="#ecosysteem">Het ecosysteem</a></li>
...
<p>Communities Abroad neemt uw privacy serieus. Deze verklaring beschrijft hoe wij, als verwerkingsverantwoordelijke, persoonsgegevens verzamelen, gebruiken, delen en beschermen via ons ecosysteem van websites, forums, directories, AI-diensten en nieuwsbrieven.</p>
...
<!-- ============================================================ -->
<h2 id="ecosysteem">3. Het ecosysteem</h2>

<p>Communities Abroad exploiteert een samenhangend digitaal ecosysteem ten behoeve van Nederlandstalige personen die in Frankrijk wonen, werken of van plan zijn daarheen te verhuizen. Dit ecosysteem bestaat uit de volgende onderling gekoppelde platforms:</p>
...
<p>Sommige tools binnen het ecosysteem slaan gegevens op in de lokale opslag van uw browser (localStorage). Deze gegevens worden niet naar onze servers verstuurd en blijven uitsluitend op uw eigen apparaat.</p>
...
<p>De platforms binnen het ecosysteem wisselen gegevens uit ten behoeve van een naadloze gebruikerservaring:</p>
...
<p>De volgende disclaimer is van toepassing op alle AI-gegenereerde content binnen het ecosysteem, waaronder antwoorden van Café Claude, gegenereerde brieven van de Correspondentie-assistent en AI-samenvattingen op Infofrankrijk.com:</p>
...
<div class="ca-privacy-footer">
  ...
  Deze privacyverklaring is van toepassing op het volledige ecosysteem: Infofrankrijk.com, Nederlanders.fr, Nedergids.nl, DoctorsOnMaps.com, CaféClaude.fr, DossierFrankrijk.nl en Frankrijknieuws.</p>
</div>
