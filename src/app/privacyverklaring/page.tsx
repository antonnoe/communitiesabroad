...
<p class="ca-privacy-meta">
  <strong>Versie:</strong> 2.3 — 1 juni 2026<br>
...
<div class="ca-privacy-toc">
  ...
  <ol>
    ...
    <li><a href="#raadplegingen">Raadplegingen en onderlinge koppeling</a></li>
...
<strong>Raadplegingen</strong> — Poll-engine (getoond op nederlanders.fr/raadplegingen)
Anonieme peilingen · Optionele opt-in voor onderlinge koppeling van gegadigden
...
<tr>
  <td><strong>Raadplegingen</strong> (nederlanders.fr/raadplegingen) — anonieme peiling én optionele koppeling van gegadigden</td>
  <td>Anonieme peiling: geen persoonsgegevens (alleen een gehashte dubbel-stem-indicator, niet herleidbaar tot een persoon). Opt-in koppeling: voornaam + e-mailadres, optioneel telefoon-/WhatsApp-nummer.</td>
  <td>Toestemming</td>
  <td>Tot 3 maanden na de door de deelnemer opgegeven periode.</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Transactionele e-mailverzending bij Raadplegingen (opt-in koppeling)</td>
  <td>Verenigde Staten</td>
  <td>Verwerkersovereenkomst (DPA); Standaard Contractbepalingen (SCC's)</td>
</tr>
</tbody>
</table>
...
<ul>
  ...
  <li><strong>Resend (Resend, Inc.)</strong> (transactionele e-mailverzending bij Raadplegingen) — gevestigd in de VS. Voor deze doorgifte zijn de Standaard Contractbepalingen (SCC's) van de Europese Commissie van toepassing.</li>
</ul>
...
<!-- ============================================================ -->
<h2 id="raadplegingen">12. Raadplegingen en onderlinge koppeling</h2>

<p>Raadplegingen is een instrument (poll-engine) waarmee Communities Abroad peilt of er onder de community belangstelling bestaat voor een bepaald initiatief. Raadplegingen worden getoond op <strong>nederlanders.fr/raadplegingen</strong> en kennen twee stromen: een anonieme peiling en een optionele opt-in koppeling van gegadigden.</p>

<ul>
  <li>Deelnemen aan de peiling is <strong>volledig anoniem</strong> en vereist geen persoonsgegevens. Om dubbele stemmen tegen te gaan wordt uitsluitend een gehashte indicator gebruikt die niet herleidbaar is tot een persoon.</li>
  <li>Alleen wie het <strong>opt-in vinkje</strong> aanvinkt, geeft aanvullend zijn of haar voornaam en e-mailadres (en optioneel een telefoon- of WhatsApp-nummer) op.</li>
  <li>Wanneer er een match ontstaat tussen gegadigden, wordt het opgegeven contact gedeeld met de <strong>vrijwillige coördinator van het betreffende regiocluster</strong>, zodat die de groep kan benaderen. De deelnemer geeft hiervoor vooraf uitdrukkelijk toestemming.</li>
  <li>Het daadwerkelijke organiseren van een initiatief (zoals reis, verblijf en kosten) valt <strong>buiten de verantwoordelijkheid van Communities Abroad</strong>. Onze rol is uitsluitend gegadigden bij elkaar brengen.</li>
  <li>De gegeven toestemming is te allen tijde intrekbaar en gegevens worden op verzoek verwijderd.</li>
</ul>

<p>De gegevens uit de opt-in koppeling worden verwerkt op grond van uw toestemming en bewaard tot uiterlijk 3 maanden na de door u opgegeven periode (zie artikel 4). Voor de verzending van e-mailberichten in het kader van Raadplegingen maken wij gebruik van Resend (zie artikelen 5 en 6).</p>

<!-- ============================================================ -->
<h2 id="datastromen">13. Datastromen tussen platforms</h2>
...
<!-- ============================================================ -->
<h2 id="rechten">15. Uw rechten onder de AVG</h2>
...
<!-- ============================================================ -->
<h2 id="datalekken">16. Datalekken</h2>
...
<!-- ============================================================ -->
<h2 id="disclaimer-ai">17. Disclaimer AI-gegenereerde informatie</h2>
...
<!-- ============================================================ -->
<h2 id="wijzigingen">19. Wijzigingen</h2>
...
<div class="ca-privacy-changelog">
  ...
  <p><strong>Versie 2.3</strong> — 1 juni 2026<br>
  Wijzigingen ten opzichte van versie 2.2:</p>
  <ul>
    <li>Nieuw instrument "Raadplegingen" (poll-engine, getoond op nederlanders.fr/raadplegingen) toegevoegd aan het netwerk van platforms (artikel 3).</li>
    <li>Nieuwe rij in de gegevenstabel voor Raadplegingen, met onderscheid tussen de anonieme peiling (geen persoonsgegevens, alleen gehashte dubbel-stem-indicator) en de optionele opt-in koppeling (voornaam + e-mailadres, optioneel telefoon/WhatsApp); grondslag toestemming; bewaartermijn tot 3 maanden na de opgegeven periode (artikel 4).</li>
    <li>Nieuw artikel 12 "Raadplegingen en onderlinge koppeling" over de twee stromen (anonieme peiling en opt-in koppeling), het delen van opt-in contact met de vrijwillige coördinator van het regiocluster, de afbakening dat het organiseren buiten de verantwoordelijkheid van Communities Abroad valt, en de intrekbaarheid van toestemming.</li>
    <li>Resend (Resend, Inc.) toegevoegd als verwerker voor transactionele e-mailverzending bij Raadplegingen (artikelen 5 en 6).</li>
    <li>Artikelen 13 t/m 19 hernummerd als gevolg van het nieuwe artikel 12.</li>
  </ul>
